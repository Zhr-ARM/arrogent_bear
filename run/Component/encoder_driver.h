...
// 编码器每转一圈的脉冲数 (PPR)
#define ENCODER_PPR (11 * 30 * 4) // 11线/相, 30倍减速比, 4倍频
// 车轮直径 (单位: 厘米)
...
#define SAMPLING_TIME_S 0.01f // 采样时间, 与任务周期一致 (10ms)
...
extern Encoder A_encoder;
extern Encoder B_encoder;
extern Encoder C_encoder;
extern Encoder D_encoder;
